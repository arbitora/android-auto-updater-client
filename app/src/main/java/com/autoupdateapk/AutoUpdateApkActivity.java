...
public class AutoUpdateApkActivity extends Activity implements Observer {
	...
	private static final String PUBLIC_APK_URL = "/anyUpdateServerRoute";
	private static final String PUBLIC_SERVER_URL = "http://192.168.0.102";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		aua = new AutoUpdateApk(getApplicationContext(), PUBLIC_APK_URL, PUBLIC_SERVER_URL);	// <-- don't forget to instantiate
